...
### Added
- **TUI Themes**: 16 built-in color themes (Tokyo Night, Catppuccin, Dracula,
  Nord, Gruvbox, One Dark, Rose Pine, Everforest, Kanagawa, Solarized,
  Flexoki, Monokai, Cobalt2, Ayu, default). Select via `tui.theme` in config.
- **TUI**: All emojis removed for professional appearance.
