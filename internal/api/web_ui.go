...
<div id="app">
  ...
  <div id="detail">
    <div id="detail-header">
      ...
      <button id="detail-close" onclick="closeDetail()" aria-label="Close details">✕</button>
    </div>
    <div id="detail-body">
    ...
    <div id="edit-form">
      <div><label for="edit-title" class="form-label">Title</label><input class="form-input" id="edit-title" type="text" placeholder="Node title"></div>
      <div>
