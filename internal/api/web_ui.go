...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .form-label{font-size:10px;color:var(--text-dim);letter-spacing:.1em;text-transform:uppercase;margin-bottom:4px;display:block}
...
<div id="app">
  ...
  <div id="detail">
    <div id="detail-header">
      ...
      <button id="detail-close" onclick="closeDetail()" aria-label="Close detail panel" title="Close detail panel">✕</button>
    </div>
    <div id="detail-body">
